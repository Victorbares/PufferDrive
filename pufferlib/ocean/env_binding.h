...
static int handler(
    ...
    } else if (MATCH("env", "reward_log_distance")) {
        env_config->reward_log_distance = atof(value);
    } else if (MATCH("env", "reward_goal_reached")) {
        env_config->reward_goal_reached = atof(value);
